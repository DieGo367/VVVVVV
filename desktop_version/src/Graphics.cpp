...
void Graphics::printcrewname( int x, int y, int t )
{
    ...
    {
    case 0:
        font::print(flags, x, y, loc::gettext(ID("Viridian", STR_VIRIDIAN)), 16, 240, 240);
        break;
    case 1:
        font::print(flags, x, y, loc::gettext(ID("Violet", STR_VIOLET)), 240, 16, 240);
        break;
    case 2:
        font::print(flags, x, y, loc::gettext(ID("Vitellary", STR_VITELLARY)), 240, 240, 16);
        break;
    case 3:
        font::print(flags, x, y, loc::gettext(ID("Vermilion", STR_VERMILION)), 240, 16, 16);
        break;
    case 4:
        font::print(flags, x, y, loc::gettext(ID("Verdigris", STR_VERDIGRIS)), 16, 240, 16);
        break;
    case 5:
        font::print(flags, x, y, loc::gettext(ID("Victoria", STR_VICTORA)), 16, 16, 240);
        break;
    }
}
...
void Graphics::printcrewnamedark( int x, int y, int t )
{
    ...
    {
    case 0:
        font::print(flags, x, y, loc::gettext(ID("Viridian", STR_VIRIDIAN)), 128,128,128);
        break;
    case 1:
        font::print(flags, x, y, loc::gettext(ID("Violet", STR_VIOLET)), 128,128,128);
        break;
    case 2:
        font::print(flags, x, y, loc::gettext(ID("Vitellary", STR_VITELLARY)), 128,128,128);
        break;
    case 3:
        font::print(flags, x, y, loc::gettext(ID("Vermilion", STR_VERMILION)), 128,128,128);
        break;
    case 4:
        font::print(flags, x, y, loc::gettext(ID("Verdigris", STR_VERDIGRIS)), 128,128,128);
        break;
    case 5:
        font::print(flags, x, y, loc::gettext(ID("Victoria", STR_VICTORA)), 128,128,128);
        break;
    }
}
...
void Graphics::printcrewnamestatus( int x, int y, int t, bool rescued )
{
    ...
    if (gender == 3 && rescued)
    {
        status_text = loc::gettext(ID("(that's you!)", STR_THATS_YOU));
    }
    else if (rescued)
    {
        status_text = loc::gettext_case(ID("Rescued!", (String_ID)(STR_RESCUED_MALE + gender - 1)), gender);
    }
    else
    {
        r = 64; g = 64; b = 64;
        status_text = loc::gettext_case(ID("Missing...", (String_ID)(STR_MISSING_MALE + gender - 1)), gender);
    }
...
void Graphics::use_tileset(int tilesetID) {
    if (tilesetID != active_tileset) {
        ...
        memcpy(bgGetGfxPtr(BG_LAYER_LEVEL), set->gfx, set->gfxSize);
...
void Graphics::drawtile3(int x, int y, int t, int off, bool background, int height_subtract /*= 0*/)
{
    ...
    int tileX = x/8, tileY = y/8;
    u16 *map = (background ? gameScreen.tilemapBackdrop : gameScreen.tilemapLevel);
    map[tileX + tileY * 64] = grphx.im_tiles3->map[t];
}

void Graphics::clear_tile(int x, int y, bool background)
{
    int tileX = x/8, tileY = y/8;
    u16 *map = (background ? gameScreen.tilemapBackdrop : gameScreen.tilemapLevel);
    map[tileX + tileY * 64] = 0;
}
...
void Graphics::drawgui(void)
{
    ...
    for (size_t i = 0; i < textboxes.size(); i++)
    {
        ...
        if (textboxes[i].image == TEXTIMAGE_LEVELCOMPLETE)
        {
            ...
            const char* translation = loc::gettext(ID(english, STR_LEVEL_COMPLETE));
        ...
        else if (textboxes[i].image == TEXTIMAGE_GAMECOMPLETE)
        {
            ...
            const char* translation = loc::gettext(ID(english, STR_GAME_COMPLETE));
            if (SDL_strcmp(english, translation) != 0
...
void Graphics::drawtrophytext(void)
{
    ...
    {
    case 1:
        top_text = loc::gettext(ID("SPACE STATION 1 MASTERED", STR_MASTERED_SS1));
        bottom_text = loc::gettext(ID("Obtain a V Rank in this Time Trial", STR_OBTAIN_A_V_RANK));
        break;
    case 2:
        top_text = loc::gettext(ID("LABORATORY MASTERED", STR_MASTERED_LAB));
        bottom_text = loc::gettext(ID("Obtain a V Rank in this Time Trial", STR_OBTAIN_A_V_RANK));
        break;
    case 3:
        top_text = loc::gettext(ID("THE TOWER MASTERED", STR_MASTERED_TOWER));
        bottom_text = loc::gettext(ID("Obtain a V Rank in this Time Trial", STR_OBTAIN_A_V_RANK));
        break;
    case 4:
        top_text = loc::gettext(ID("SPACE STATION 2 MASTERED", STR_MASTERED_SS2));
        bottom_text = loc::gettext(ID("Obtain a V Rank in this Time Trial", STR_OBTAIN_A_V_RANK));
        break;
    case 5:
        top_text = loc::gettext(ID("WARP ZONE MASTERED", STR_MASTERED_WARP_ZONE));
        bottom_text = loc::gettext(ID("Obtain a V Rank in this Time Trial", STR_OBTAIN_A_V_RANK));
        break;
    case 6:
        top_text = loc::gettext(ID("FINAL LEVEL MASTERED", STR_MASTERED_FINAL));
        bottom_text = loc::gettext(ID("Obtain a V Rank in this Time Trial", STR_OBTAIN_A_V_RANK));
        break;
    case 7:
        top_text = loc::gettext(ID("GAME COMPLETE", STR_GAME_COMPLETE_TROPHY));
        bottom_text = loc::gettext_case(ID("Complete the game", STR_COMPLETE_THE_GAME_TROPHY), 1);
        break;
    case 8:
        top_text = loc::gettext(ID("FLIP MODE COMPLETE", STR_FLIP_MODE_COMPLETE));
        bottom_text = loc::gettext(ID("Complete the game in flip mode", STR_COMPLETE_FLIP_MODE));
        break;
    case 9:
        bottom_text = loc::gettext(ID("Win with less than 50 deaths", STR_UNDER_50_DEATHS));
        break;
    case 10:
        bottom_text = loc::gettext(ID("Win with less than 100 deaths", STR_UNDER_100_DEATHS));
        break;
    case 11:
        bottom_text = loc::gettext(ID("Win with less than 250 deaths", STR_UNDER_250_DEATHS));
        break;
    case 12:
        bottom_text = loc::gettext(ID("Win with less than 500 deaths", STR_UNDER_500_DEATHS));
        break;
    case 13:
        bottom_text = loc::gettext(ID("Last 5 seconds on the Super Gravitron", STR_LAST_5_SECONDS));
        break;
    case 14:
        bottom_text = loc::gettext(ID("Last 10 seconds on the Super Gravitron", STR_LAST_10_SECONDS));
        break;
    case 15:
        bottom_text = loc::gettext(ID("Last 15 seconds on the Super Gravitron", STR_LAST_15_SECONDS));
        break;
    case 16:
        bottom_text = loc::gettext(ID("Last 20 seconds on the Super Gravitron", STR_LAST_20_SECONDS));
        break;
    case 17:
        bottom_text = loc::gettext(ID("Last 30 seconds on the Super Gravitron", STR_LAST_30_SECONDS));
        break;
    case 18:
        bottom_text = loc::gettext(ID("Last 1 minute on the Super Gravitron", STR_LAST_1_MINUTE));
        break;
    case 20:
        top_text = loc::gettext(ID("MASTER OF THE UNIVERSE", STR_MASTER_OF_THE_UNIVERSE));
        bottom_text = loc::gettext(ID("Complete the game in no death mode", STR_COMPLETE_NO_DEATH));
        break;
    }
...
void Graphics::drawbackground( int t )
{
    ...
    case 7:
        ...
        for (int j = 0; j < 30; j++)
        {
            ...
            {
                #ifdef __NDS__
                drawtile3(i * 8, j * 8, map.tower.backat(i, j, 200), 15, true);
                #else
    ...
    case 8:
        ...
        for (int j = 0; j < 30; j++)
        {
            ...
            {
                #ifdef __NDS__
                drawtile3(i * 8, j * 8, map.tower.backat(i, j, 200), 10, true);
                #else
    ...
    case 9:
        ...
        for (int j = 0; j < 30; j++)
        {
            ...
            {
                #ifdef __NDS__
                drawtile3(i * 8, j * 8, map.tower.backat(i, j, 600), 0, true);
                #else
        ...
        for (int y = 0; y < 30; y++)
        {
            for (int x = 0; x < 40; x++)
            {
                ...
                if (tile > 0)
                {
                    ...
                    {
                        #ifdef __NDS__
                        drawtile3(x * 8, y * 8, tile, map.rcol, false);
                        #else
...
void Graphics::drawtowermap(void)
{
    ...
    #endif
    {
        for (int i = 0; i < 40; i++)
        {
            ...
            {
                #ifdef __NDS__
                drawtile3(i * 8, (j * 8 + yoff + 512) % 512, temp, towerbg.colstate, false);
                #else
    ...
    else
    {
        for (int i = 0; i < 40; i++)
        {
            ...
            if (temp > 0)
            {
                drawtile3(i * 8, (-1 * 8 + yoff + 512) % 512, temp, towerbg.colstate, false);
            }
            else
            {
                clear_tile(i * 8, (-1 * 8 + yoff + 512) % 512, false);
            }
            temp = map.tower.at(i, 31, yoff);
            if (temp > 0)
            {
                drawtile3(i * 8, (31 * 8 + yoff) % 512, temp, towerbg.colstate, false);
            }
            else
            {
                clear_tile(i * 8, (31 * 8 + yoff) % 512, false);
            }
        }
    }
    foregrounddrawn = true;
...
bool Graphics::checktexturesize(
    ...
    if (!valid)
    {
        FILESYSTEM_setLevelDirError(
            loc::gettext(ID("{filename} dimensions not exact multiples of {width} by {height}!", STR_BAD_DIMENSIONS)),
